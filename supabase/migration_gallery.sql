-- ============================================
-- MIGRATION: Galerij (De Slimste Mens)
-- Set of images, each with an answer, under an optional shared theme.
-- Single input → server fuzzy-matches against unfound items' answers.
-- Fixed or placement scoring per item.
-- One total max-attempts counter across the whole challenge.
-- Run AFTER previous Open Deur + Puzzle migrations.
-- ============================================
...
-- Extend finalize_challenge to handle 'gallery'
